...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[OntologyElement],[Node]<has%20direct%20replacement%201..1-%20[NodeObsoletionWithDirectReplacement&#124;change_description:string%20%3F;about_node_representation(i):string%20%3F;language(i):language_tag%20%3F;old_value(i):string%20%3F;new_value(i):string%20%3F;old_value_type(i):string%20%3F;new_value_type(i):string%20%3F;new_language(i):string%20%3F;old_language(i):string%20%3F;new_datatype(i):string%20%3F;old_datatype(i):string%20%3F;id(i):string;see_also(i):string%20%3F;pull_request(i):string%20%3F;creator(i):string%20%3F;change_date(i):string%20%3F;contributor(i):string%20%3F],[NodeObsoletionWithDirectReplacement]uses%20-.->[AllowsAutomaticReplacementOfEdges],[NodeObsoletion]^-[NodeObsoletionWithDirectReplacement],[NodeObsoletion],[Node],[Change],[AllowsAutomaticReplacementOfEdges],[Activity])](https://yuml.me/diagram/nofunky;dir:TB/class/[OntologyElement],[Node]<has%20direct%20replacement%201..1-%20[NodeObsoletionWithDirectReplacement&#124;change_description:string%20%3F;about_node_representation(i):string%20%3F;language(i):language_tag%20%3F;old_value(i):string%20%3F;new_value(i):string%20%3F;old_value_type(i):string%20%3F;new_value_type(i):string%20%3F;new_language(i):string%20%3F;old_language(i):string%20%3F;new_datatype(i):string%20%3F;old_datatype(i):string%20%3F;id(i):string;see_also(i):string%20%3F;pull_request(i):string%20%3F;creator(i):string%20%3F;change_date(i):string%20%3F;contributor(i):string%20%3F],[NodeObsoletionWithDirectReplacement]uses%20-.->[AllowsAutomaticReplacementOfEdges],[NodeObsoletion]^-[NodeObsoletionWithDirectReplacement],[NodeObsoletion],[Node],[Change],[AllowsAutomaticReplacementOfEdges],[Activity])
